...
def new_slidingthermo_editing(mRNA, gRNA, position, anchorsize, windowsize, mismatches_currently, mismatches_allowed,
    ...
    class Node():
        ...
        def add_stay(self):
            ...
            # To avoid passing it all the way down stay children, only pass it when the deletion occurred at this node (i.e. U in mRNA), not when it was inherited from a parent node.
