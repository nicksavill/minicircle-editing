...
class Node():
    ...
    def add_edge(self, target_node, new_gRNA_name, thermo_probability=None):
    ...
    #
    def update_edited_position(self, latest_start_position, new_edited_until):
        self.edited_until = new_edited_until
        self.latest_start = latest_start_position
...
class Edge():
    def __init__(self, start=None, target=None, gRNA=None, thermo_probability=None):
