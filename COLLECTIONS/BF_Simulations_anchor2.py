from COLLECTIONS import AnchorAligners, Editors, BF_Network_anchor
import sys, time, os
...
class Simulation():
    ...
    def initialize(self, filepath_gene, filepath_control, filepath_RNAs, filepath_nodes, second_round=False):
        ...
        root = BF_Network_anchor.Node(name='"unedited mRNA"', mRNA=self.mRNA_unedited, edited_until=len(self.mRNA_unedited))
