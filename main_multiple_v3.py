from COLLECTIONS import Programs2
'''
...
genes = ["RPS12", "ND9", "ND8_v2", "ND8_v1", "ND7", "ND3", "MURF2", "CYB", "CR4", "CR3", "A6_v1", "A6_v2", "COX3"]
genes2 = [ "ND8_v1", "ND8_v2", "ND3", "MURF2", "CYB", "CR3", "CR4", "COX3", "A6_v1", "A6_v2"]
genes3 = ["CR4"]
genes4 = ["ND8_v2", "ND9"]
...
for gene in genes6:
    ...
    for type in simulationtypes:
        ...
        filepath_gRNAs = "./FILES/latest_grnas/"+gene+"_grnas.fa"
        ...
        directorypath_output = "./OUTPUT/top3_final"

        # The type of gRNA data used. E.g. "Real", "Artificial", "RealSubsetA6"...
        used_gRNAs = "RealSubset_noU_noelse_" + gene
