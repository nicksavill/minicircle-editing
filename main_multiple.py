...
genes = ["CR4", "RPS12", "ND9", "ND8_v2", "ND8_v1", "ND7", "ND3", "MURF2", "CR3", "COX3", "CYB", "A6_v1", "A6_v2"]
genes2 = ["ND9", "CR4", "CYB", "CR3"]
genes3 = ["ND8_v1", "ND3", "A6_v1", "A6_v2"]
genes4 = ["ND8_v1", "ND3"]
genes5 = ["ND3", "A6_v1", "A6_v2", "CYB", "ND7"]
genes6 = ["RPS12", "ND7"]
genes7 = ['CR3']
...
for gene in genes7:
    ...
    for type in simulationtypes:
        ...
        filepath_gene = "./FILES/new_unedited_mRNAs/unedited_"+gene.split("_")[0]+".fa"
        ...
        filepath_control = "./FILES/new_edited_mRNAs/edited_"+gene+".fa"
        ...
        #if gene.find("ND8") > -1 or gene == "RPS12":
        #    threshold = 1e-40
        #elif gene == "CR3":
        #    threshold = 1e-15
        #elif gene == "RPS12":
        ...
        directorypath_output = "./OUTPUT/11_8_best_CO"

        # The type of gRNA data used. E.g. "Real", "Artificial", "RealSubsetA6"...
        used_gRNAs = "RealSubset_" + gene
        ...
        # display and save the generated graph in graphviz / png format.
